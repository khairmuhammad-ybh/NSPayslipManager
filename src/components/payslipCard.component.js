...
class PayslipCard extends Component {
    ...
    swipeBtns = [{
        ...
        onPress: () => {
            ...
            servicePayslip.removeSingleComparedPayslip(store.getState().Payslip.payslips[this.state.activeRow]).then(() => {
                    ...
                    <View style={styles.cardContent}>
                        <View style={styles.flexContainerRow}>
                            ...
                            <View
                                ...
                                <Text
                                    style={parseFloat(payslip.mealAllowance.actual) > parseFloat(payslip.mealAllowance.expected) ?
                                        { color: 'green' } :
                                        parseFloat(payslip.mealAllowance.actual) == parseFloat(payslip.mealAllowance.expected) ?
                                            { color: 'black' } :
                                            { color: 'red' }}>${payslip.mealAllowance.actual}</Text>
                                <Text
