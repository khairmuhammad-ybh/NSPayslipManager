                    ...
                    <View style={styles.userInfoSection}>
                        <View style={{flexDirection: 'row', marginTop: 15}}>
                            <View style={{marginLeft: 15, flexDirection: 'column'}}>
                                <Text style={styles.title}>Name: {store.getState().Profile.name}</Text>
                                <Text style={styles.caption}>Rank: {store.getState().Profile.rank}</Text>
                                <Text style={styles.caption}>Vocation: {store.getState().Profile.vocation}</Text>
                            </View>
                        </View>
                    </View>
